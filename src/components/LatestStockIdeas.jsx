  ...
  return(
    <>
      <div className = 'pt-10 relative'>
        <h3 className = 'text-blacklight text-xl lg:text-2xl font-bold pb-8 absolute top-12'>Latest Stock Ideas</h3>
        ...
        >
          {
            CaseStudiesArray.length > 0 && CaseStudiesArray.map((val, i) => (
              <Link to = "/dataroom-details" className = 'block w-custom94 h-48 bg-white rounded-2xl relative px-4 lg:px-7 pb-7 border-t-2 border-green_dark  cursor-pointer duration-500 hover:-translate-y-1' key = { i }>
...
export default LatestStockIdeas;