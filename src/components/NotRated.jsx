...
const NotRated = () => {
  ...
  const CaseStudiesArray = [
    {
      label: '<div class = \'stockitem bg-primary w-24 lg:w-28 xl:w-32 text-white text-sm text-center py-1.5 absolute right-0 rounded-tr-lg\'>Not Rated</div>',
      img: item,
      heading: '01',
  ...
  return(
    <>
      <div className = 'pt-10 relative'>
        <h3 className = 'text-blacklight text-xl lg:text-2xl font-bold pb-8 absolute top-12'>Not Rated (Not Recommended)</h3>
        ...
        >
          {
            CaseStudiesArray.length > 0 && CaseStudiesArray.map((val, i) => (
              <div className = 'w-custom94 h-48 bg-white rounded-2xl relative px-4 lg:px-7 pb-7 border-t-2 border-primary  cursor-pointer duration-500 hover:-translate-y-1' key = { i }>
